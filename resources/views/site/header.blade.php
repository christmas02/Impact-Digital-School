    ...
    <div class="modal-dialog modal-lg modal-confirm">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="title-eve">Imscription<span> a la journee</span> de formation</h1>
            </div>
            <div class="modal-body">
                <form class="row">
                    ...
                    <div class="form-group col-md-6">
                       <input class="form-control form-control-lg" type="text" placeholder="Votre prenom">
                    ...
                    <div class="form-group col-md-12">
                       <input class="form-control form-control-lg" type="text" placeholder="Niveau d'etude">
                       <small id="" class="form-text text-muted">Champs obligatoire</small>
                    </div>
                    <div class="form-group col-md-12">
                       <input class="form-control form-control-lg" type="text" placeholder="Profession actuelle">
                       <small id="" class="form-text text-muted">Champs obligatoire</small>
                    </div>

                    <div class="form-group col-md-12">
                       <textarea class="form-control form-control-lg" placeholder="Quelle sont vos attente pour cette formation"></textarea>
